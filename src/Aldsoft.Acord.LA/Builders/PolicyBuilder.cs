namespace Aldsoft.Acord.LA.Builders
{
        ...
        Properties_PolicyBuilder<Sans_Properties_PolicyBuilder>
    {
        ...
        public abstract Sans_Item_PolicyBuilder WithLife(IBuilder<Life_Type> builder);
        public abstract Sans_Item_PolicyBuilder WithAnnuity(Annuity_Type annuity);
        public abstract Sans_Item_PolicyBuilder WithAnnuity(IBuilder<Annuity_Type> builder);
        public abstract Sans_Item_PolicyBuilder WithDisabilityHealth(DisabilityHealth_Type disabilityHealth);
        public abstract Sans_Item_PolicyBuilder WithDisabilityHealth(IBuilder<DisabilityHealth_Type> builder);
        public abstract Sans_Item_PolicyBuilder WithPropertyandCasualty(PropertyandCasualty_Type propertyAndCasualty);
        public abstract Sans_Item_PolicyBuilder WithPropertyandCasualty(IBuilder<PropertyandCasualty_Type> builder);
    }
    ...
    public abstract class PolicyBuilder_Sans_Item_PolicyBuilder : PolicyBuilder_Sans_Properties_PolicyBuilder,
        Sans_Item_PolicyBuilder
    {
        protected PolicyBuilder_Sans_Item_PolicyBuilder() : base() { }
        protected PolicyBuilder_Sans_Item_PolicyBuilder(Policy_Type baseEntity) : base(baseEntity) { }

        Sans_Item_PolicyBuilder Properties_PolicyBuilder<Sans_Item_PolicyBuilder>.AddOLifEExtension(IBuilder<OLifEExtension_Type> builder) { return (Sans_Item_PolicyBuilder)AddOLifEExtension(builder); }
        Sans_Item_PolicyBuilder Properties_PolicyBuilder<Sans_Item_PolicyBuilder>.AddOLifEExtension(OLifEExtension_Type oLifeExtension) { return (Sans_Item_PolicyBuilder)AddOLifEExtension(oLifeExtension); }
    }

    public class PolicyBuilder : PolicyBuilder_Sans_Item_PolicyBuilder
    {
        ...
        protected override void ValidateBaseObject(Policy_Type baseEntity)
        {
            if (baseEntity.ShouldSerializeItem1())
                throw new ArgumentException("The Policy_Type.Item value should not be set. This builder will help handle the ACORD spec logic with setting this property.", "baseEntity");
        }
        ...
        public override Sans_Item_PolicyBuilder WithLife(IBuilder<Life_Type> builder)
        {
            _buildPropertiesActions.AddLast(n => n.Item1 = builder.Build());
            return this;
        }

        public override Sans_Item_PolicyBuilder WithAnnuity(Annuity_Type annuity)
        {
            _buildPropertiesActions.AddLast(n => n.Item1 = annuity);
            return this;
        }

        public override Sans_Item_PolicyBuilder WithAnnuity(IBuilder<Annuity_Type> builder)
        {
            _buildPropertiesActions.AddLast(n => n.Item1 = builder.Build());
            return this;
        }

        public override Sans_Item_PolicyBuilder WithDisabilityHealth(DisabilityHealth_Type disabilityHealth)
        {
            _buildPropertiesActions.AddLast(n => n.Item1 = disabilityHealth);
            return this;
        }

        public override Sans_Item_PolicyBuilder WithDisabilityHealth(IBuilder<DisabilityHealth_Type> builder)
        {
            _buildPropertiesActions.AddLast(n => n.Item1 = builder.Build());
            return this;
        }

        public override Sans_Item_PolicyBuilder WithPropertyandCasualty(PropertyandCasualty_Type propertyAndCasualty)
        {
            _buildPropertiesActions.AddLast(n => n.Item1 = propertyAndCasualty);
            return this;
        }

        public override Sans_Item_PolicyBuilder WithPropertyandCasualty(IBuilder<PropertyandCasualty_Type> builder)
        {
            _buildPropertiesActions.AddLast(n => n.Item1 = builder.Build());
            return this;
        }
    ...
    public interface Item_PolicyBuilder<TRemainder>
    {
    ...
    public interface Sans_Properties_PolicyBuilder :
        ...
        Properties_PolicyBuilder<Sans_Properties_PolicyBuilder>,
        Item_PolicyBuilder<Sans_Item_PolicyBuilder>
    { }

    // level one reductions
    public interface Sans_Item_PolicyBuilder :
        IBuilder<Policy_Type>,
        Properties_PolicyBuilder<Sans_Item_PolicyBuilder>
    { }
}
