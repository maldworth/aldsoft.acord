namespace Aldsoft.Acord.LA.Tests.V2_31_00
{
    ...
    class PartyBuilderTests
    {
        ...
        [Test]
        public void V2_31_00_PartyBuilder_NotSet_Test2()
        {
            // Arrange
            var builder = Party_Type.CreateBuilder();
        ...
        [Test]
        public void V2_31_00_PartyBuilder_Build_CannotSetPartyTypeCode()
        {
            // Arrange
            var builder = Party_Type.CreateBuilder()
                .WithUnknown();
        ...
        [Test]
        public void V2_31_00_PartyBuilder_Build_CannotSetItem()
        {
            // Arrange
            var builder = Party_Type.CreateBuilder()
                .WithUnknown();
