namespace Aldsoft.Acord.LA.Tests.V2_34_00
{
    ...
    {
        [Test]
        public void V2_34_00_LifeBuilder_NoBaseCoverage()
        {
            // Arrange
        ...
        [Test]
        public void V2_34_00_LifeBuilder_CannotConstructWithCoverage()
        {
            // Arrange/Act/Assert
        ...
        [Test]
        public void V2_34_00_LifeBuilder_CannotBuildWithCoverage()
        {
            // Arrange
            var builder = Life_Type.CreateBuilder();
        ...
        [Test]
        public void V2_34_00_LifeBuilder_ConstructWithLife()
        {
            // Arrange
        ...
        [Test]
        public void V2_34_00_LifeBuilder_BuildWithLife()
        {
            // Arrange
            var builder = Life_Type.CreateBuilder()
