namespace Aldsoft.Acord.Tests.LA
{
    ...
    {
        [Test]
        public void PartyBuilder_NotSet_Test1()
        {
            // Arrange
        ...
        [Test]
        public void PartyBuilder_NotSet_Test2()
        {
            // Arrange
            var builder = Party_Type.CreateBuilder();
        ...
        [Test]
        public void PartyBuilder_CreateBuilder_CannotSetPartyTypeCode()
        {
            // Arrange/Act/Assert
            var ex = Assert.Throws<ArgumentException>(() => PartyBuilder.CreateBuilder(new Party_Type { PartyTypeCode = OLI_LU_PARTY.OLI_PT_PERSON }));
            Assert.IsTrue(ex.Message.Contains("The Party_Type.PartyTypeCode value should not be set."));
        }

        [Test]
        public void PartyBuilder_CreateBuilder_CannotSetItem()
        {
            // Arrange/Act/Assert
        ...
        [Test]
        public void PartyBuilder_Build_CannotSetPartyTypeCode()
        {
            // Arrange
            var builder = Party_Type.CreateBuilder()
                .WithUnknown();
        ...
        [Test]
        public void PartyBuilder_Build_CannotSetItem()
        {
            // Arrange
            var builder = Party_Type.CreateBuilder()
                .WithUnknown();
        ...
        [Test]
        public void PartyBuilder_Unknown()
        {
            // Arrange
        ...
        [Test]
        public void PartyBuilder_Person()
        {
            // Arrange
        ...
        [Test]
        public void PartyBuilder_Organization()
        {
            // Arrange
            var entity = Party_Type.CreateBuilder()
