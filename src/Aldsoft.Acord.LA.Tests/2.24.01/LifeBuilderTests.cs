...
namespace Aldsoft.Acord.LA.Tests.V2_24_01
{
    ...
    {
        [Fact]
        public void V2_24_01_LifeBuilder_NoBaseCoverage()
        {
            // Arrange
        ...
        [Fact]
        public void V2_24_01_LifeBuilder_CannotConstructWithCoverage()
        {
            // Arrange/Act/Assert
        ...
        [Fact]
        public void V2_24_01_LifeBuilder_CannotBuildWithCoverage()
        {
            // Arrange
            var builder = Life_Type.CreateBuilder();
        ...
        [Fact]
        public void V2_24_01_LifeBuilder_ConstructWithLife()
        {
            // Arrange
        ...
        [Fact]
        public void V2_24_01_LifeBuilder_BuildWithLife()
        {
            // Arrange
            var builder = Life_Type.CreateBuilder()
