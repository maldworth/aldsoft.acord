namespace Aldsoft.Acord.LA.Tests.V2_26_00
{
    ...
    {
        [Fact]
        public void V2_26_00_LifeBuilder_NoBaseCoverage()
        {
            // Arrange
        ...
        [Fact]
        public void V2_26_00_LifeBuilder_CannotConstructWithCoverage()
        {
            // Arrange/Act/Assert
        ...
        [Fact]
        public void V2_26_00_LifeBuilder_CannotBuildWithCoverage()
        {
            // Arrange
            var builder = Life_Type.CreateBuilder();
        ...
        [Fact]
        public void V2_26_00_LifeBuilder_ConstructWithLife()
        {
            // Arrange
        ...
        [Fact]
        public void V2_26_00_LifeBuilder_BuildWithLife()
        {
            // Arrange
            var builder = Life_Type.CreateBuilder()
