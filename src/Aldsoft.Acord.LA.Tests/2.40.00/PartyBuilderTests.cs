namespace Aldsoft.Acord.LA.Tests.V2_40_00
{
    extern alias V2_40_00;
    using V2_40_00::Aldsoft.Acord.LA;
    using Xunit;
    using System;
    ...
    {
        [Fact]
        public void V2_40_00_PartyBuilder_NotSet_Test1()
        {
            // Arrange
        ...
        [Fact]
        public void V2_40_00_PartyBuilder_NotSet_Test2()
        {
            // Arrange
            var builder = Party_Type.CreateBuilder();
        ...
        [Fact]
        public void V2_40_00_PartyBuilder_CreateBuilder_CannotSetPartyTypeCode()
        {
            // Arrange/Act/Assert
        ...
        [Fact]
        public void V2_40_00_PartyBuilder_CreateBuilder_CannotSetItem()
        {
            // Arrange/Act/Assert
        ...
        [Fact]
        public void V2_40_00_PartyBuilder_Build_CannotSetPartyTypeCode()
        {
            // Arrange
            var builder = Party_Type.CreateBuilder()
                .WithUnknown();
        ...
        [Fact]
        public void V2_40_00_PartyBuilder_Build_CannotSetItem()
        {
            // Arrange
            var builder = Party_Type.CreateBuilder()
                .WithUnknown();
        ...
        [Fact]
        public void V2_40_00_PartyBuilder_Unknown()
        {
            // Arrange
        ...
        [Fact]
        public void V2_40_00_PartyBuilder_Person()
        {
            // Arrange
        ...
        [Fact]
        public void V2_40_00_PartyBuilder_Organization()
        {
            // Arrange
            var entity = Party_Type.CreateBuilder()
